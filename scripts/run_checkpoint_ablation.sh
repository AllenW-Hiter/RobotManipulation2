...
#
# 启动全部 12 个 checkpoint ablation run：
...
#
# 用法：
#   bash scripts/run_checkpoint_ablation.sh              # 执行全部 run
#   DRY_RUN=1 bash scripts/run_checkpoint_ablation.sh    # 只打印命令
#   NUM_GPUS=4 bash scripts/run_checkpoint_ablation.sh   # 每个 run 使用 4 张 GPU
...
# ---------------------------------------------------------------------------
# 全部 checkpoint ablation run 的共享参数 (Can, step_6000)
# ---------------------------------------------------------------------------
SHARED_ARGS=(
  --distributed True
