...
#
# 用法：
#   bash scripts/run_fpo_ablation.sh              # 执行全部 run
#   DRY_RUN=1 bash scripts/run_fpo_ablation.sh    # 只打印命令
#   NUM_GPUS=4 bash scripts/run_fpo_ablation.sh   # 每个 run 使用 4 张 GPU
...
# ---------------------------------------------------------------------------
# 共享 参数 for ALL FPO ablation runs
# ---------------------------------------------------------------------------
SHARED_ARGS=(
  --distributed True
