...
# -----------------------------------------------------------------------------
# 评估辅助函数 (reused from pretrain_flow_bc.py)
# -----------------------------------------------------------------------------
...
def _run_rollouts(
    *,
    ...
    # 计算均值和标准差 of successes_list across environments
...
def main(cfg: EvalCheckpointConfig):
    ...
    # 更新 cfg.image_observation_keys from config fnames
