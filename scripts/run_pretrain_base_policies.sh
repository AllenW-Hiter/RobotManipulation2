...
#
# All base policies share these hyper参数:
#   - network: MLP [1024,1024,1024] with ViT vision backbone
#   - flow_network_output_param=u, cfm_loss_mode=u (速度预测)
...
#   DRY_RUN=1 bash scripts/run_pretrain_base_policies.sh    # 只打印命令
...
# ---------------------------------------------------------------------------
# 共享 参数 across all 5 base policies
# ---------------------------------------------------------------------------
SHARED_ARGS=(
    --policy flowmatching
