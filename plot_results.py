        ...
        for run_id in tqdm(config["run_ids"]):
            try:
                ...
                if config["use_merge_asof"]:
                    # 分别获取稀疏 eval metric 和密集 training step
                ...
                # 添加初始点 (if initial_rate is provided)
...
def downsample_data(df, factor):
    """下采样数据 by keeping every Nth point per Group."""
    if factor <= 1:
        return df
...
def smooth_data(df, smoothing):
    """应用指数移动平均平滑 to Success Rate per Group."""
    if smoothing <= 0:
        return df
...
# =============================================================================
# Mode: main_benchmark (全部 5 个任务和 4 种方法, zero + random sampling)
# =============================================================================
...
def run_main_benchmark(api, output):
    ...
    # =============================================================================
    # Box Clearance 配置 (Zero Sampling)
    # =============================================================================
    ...
    # =============================================================================
    # Box Clearance 配置 (Random Sampling)
    # =============================================================================
    ...
    # =============================================================================
    # Tray Lifting 配置 (Random Sampling)
    # =============================================================================
    ...
    if zero_data_available or random_data_available:
        ...
        # 绘制 Box Clearance (Zero Sampling)
        ...
        # 绘制 Box Clearance (Random Sampling)
        ...
        # 绘制 Tray Lifting (Random Sampling)
...
# =============================================================================
# Mode: base_policy_ablation (Can task, 多视图, zero vs random sampling)
# =============================================================================
