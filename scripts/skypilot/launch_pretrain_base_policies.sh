#!/bin/bash
#
# launch_pretrain_base_policies.sh (SkyPilot - 远程 cluster 启动器)
#
# 通过 SkyPilot 在 EC2 上启动 5 个 base policy 预训练任务。
# 每个任务使用独立的 EC2 cluster 和 1 张 L40S GPU。
#
# Base policy: Flow Matching BC with 速度预测 (u/u), L2 loss,
